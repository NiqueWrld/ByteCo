...
import com.niquewrld.buildco.Domain.ReviewDomaim;
import com.niquewrld.buildco.databinding.ViewholderReviewBinding;

import java.util.ArrayList;

public class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.Viewholder> {
    ArrayList<ReviewDomaim> items;
    Context context;

    public ReviewAdapter(ArrayList<ReviewDomaim> items){
        this.items = items;
    }
    ...
    public void onBindViewHolder(@NonNull ReviewAdapter.Viewholder holder, int position) {
        ...
        holder.binding.discTxt.setText(items.get(position).getDescription());
